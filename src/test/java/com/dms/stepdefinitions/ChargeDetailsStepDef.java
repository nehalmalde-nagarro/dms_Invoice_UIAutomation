...
public class ChargeDetailsStepDef {
	...
	public void Verify_Prefilled_fields_for_OrderId_from_scenario_on_Charge_Details_tab(int rowNo) throws Exception {
		...
		String sellingPriceBE=Query.get_fields_From_SM_PRICE_FOR_with_mutiple_conditions("SELL_PRICE_L", "COLOR_IND", colorCD, "VARIANT_CD",variantCD, "SALES_TYPE", saleType);
